...
public class DescribeExistingTables {
    public static void main(String[] args) throws Exception {
        ...
        String[] tables = {"base_region_tb", "base_customer_tb", "base_industry_tb", "model_forecast_config_tb", "model_forecast_record_tb", "model_train_record_tb", "model_train_batch_tb",
                "model_forecast_result_tb", "model_predict_winter_result_tb", "model_train_backtest_tb", "data_winter_tenday_dataset_tb"};
